...
public class Matcher {
     ...
     * @throws IllegalArgumentException в случае, если в {@code character} пуст или
     *                                  более одного символа.
     * @throws NullPointerException     в случае {@code character} равного
     *                                  {@code null}
     */
    public static boolean match(String str, String character) {
        ...
        long delay = 100;
        // корректная обработка InterruptedException для метода, который не предполагает
        // проброс этого исключения
        try {
            Thread.sleep(delay);
